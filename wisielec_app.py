...
class Ui_statystyki(QWidget):                                                                               
    def setupUi(self, statystyki):                                                                          
        ...
        self.Ilosc_wyg_tablica.setGeometry(QtCore.QRect(20, 100, 350, 60))                                  
        font = QtGui.QFont()                                                                                
        ...
        self.ilosc_przeg_tablica.setGeometry(QtCore.QRect(20, 260, 420, 60))                                
        font = QtGui.QFont()                                                                                
        font.setPointSize(20)                                                                               
        ...
        self.wygrane_LCD.setGeometry(QtCore.QRect(40, 160, 150, 80))                                        
        self.wygrane_LCD.setObjectName("wygrane_LCD")                                                       
        self.suma_tablica = QtWidgets.QLabel(self.centralwidget)
        self.suma_tablica.setGeometry(QtCore.QRect(520, 100, 350, 60))                                     
        font = QtGui.QFont()                                                                                
        font.setPointSize(20)                                                                               
        ...
        self.suma.setGeometry(QtCore.QRect(550, 160, 350, 80))                                              
        self.suma.setObjectName("suma")                                                                     
        self.przegrane_LCD = QtWidgets.QLCDNumber(self.centralwidget)                                       
        self.przegrane_LCD.setGeometry(QtCore.QRect(40, 320, 150, 80))                                      
